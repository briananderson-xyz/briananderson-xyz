    ...
    extend: {
      ...
      colors: {
        ...
        skin: {
          ...
          "success-contrast": withOpacity("--color-status-success-contrast"),
          warning: withOpacity("--color-status-warning"),
          "warning-contrast": withOpacity("--color-status-warning-contrast"),
          error: withOpacity("--color-status-error"),
          "error-contrast": withOpacity("--color-status-error-contrast")
        }
      },
